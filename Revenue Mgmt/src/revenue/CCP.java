...
public class CCP 
{
            ...
            for(int i=0;i<timeSlot;i++)
            {
                ...
                for(int j=0;j<JobNo.size();j++)
                {
                    ...
                    if(slt1>0)
                    {
                        ...
                        double ut1=(double)cpu/(double)CPU_max;
                        double ut2=(double)store/(double)Store_max;
                        double ut3=(double)band/(double)Band_max;
                        ...
                        if(bo1 && bo2 && bo3)
                        {
                            ...
                            for(int k=j+1;k<JobNo.size();k++)
                            {
                                ...
                                if(slt2>0)
                                {
                                    ...
                                    double ut11=(double)cpu2/(double)CPU_max;
                                    double ut12=(double)store2/(double)Store_max;
                                    double ut13=(double)band2/(double)Band_max;
                                    ...
                                    double ut21=(double)cp/(double)CPU_max;
                                    double ut22=(double)ste/(double)Store_max;
                                    double ut23=(double)ba/(double)Band_max;
     ...
     public void displayGraph()
    {
        try
        {
            ...
            ChartFrame frame1=new ChartFrame("Client Classification Graph",chart);
